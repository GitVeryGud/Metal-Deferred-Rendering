...
//    MeshNode* baseNode;
//    
//    void renderDeferred(MTL::RenderCommandEncoder* pEnc);
//    void DrawDeferred( MTL::RenderCommandEncoder* pEnc) override;
//private:
//    MTL::Device* device;
//    MTL::Buffer* vertexBuffer;
//    MTL::Buffer* textureBuffer;
//    MTL::Buffer* normalsBuffer;
//    MTL::Buffer* tangentsBuffer;
//    MTL::Buffer* bitangentsBuffer;
//    
//    Mesh** meshes;
////    MeshNode* baseNode;
...
//    simd::float3* tangents = nullptr;
//    simd::float3* bitangents = nullptr;
//    
//    size_t numMeshes = 0;
...
//    
//    Texture** gTextures = new Texture*[3];
//    
